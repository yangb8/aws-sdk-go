...
type LogConfiguration struct {
	...
	// container agent project that is available on GitHub (https://github.com/yangb8/amazon-ecs-agent)
...
type VersionInfo struct {
	...
	//  (https://github.com/yangb8/amazon-ecs-agent/commits/master) GitHub repository.
